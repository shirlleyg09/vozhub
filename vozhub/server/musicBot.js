...
const RADIOS_FIXAS = [
  ...
  // ── INTERNACIONAL — SomaFM (HTTPS garantido) + Zeno.FM ──
  // SomaFM — todos HTTPS, sem bloqueio
  { id:'int_lofi',       name:'Lofi Hip Hop',            emoji:'🎧', url:'https://stream.zeno.fm/0r0xa792kwzuv',           genre:'Lo-fi'    },
  { id:'int_chill',      name:'Groove Salad (Chill)',    emoji:'🌊', url:'https://somafm.com/groovesalad256.mp3',          genre:'Chill'    },
  { id:'int_hiphop',     name:'Hip-Hop / Rap',           emoji:'🎤', url:'https://stream.zeno.fm/f3e4rqrmb5zuv',           genre:'Hip-Hop'  },
  { id:'int_trap',       name:'Trap & Bass',             emoji:'🔊', url:'https://stream.zeno.fm/4d5n1qrmb5zuv',           genre:'Trap'     },
  { id:'int_rnb',        name:'R&B Soul',                emoji:'💜', url:'https://somafm.com/somaside130.pls',             genre:'R&B'      },
  { id:'int_indie',      name:'Indie Pop Rocks',         emoji:'🪨', url:'https://somafm.com/indiepop130.pls',             genre:'Indie'    },
  { id:'int_rock',       name:'Rock Hits',               emoji:'🎸', url:'https://stream.zeno.fm/yn65m0tmdrhvv',           genre:'Rock'     },
  { id:'int_metal',      name:'Metal / Heavy',           emoji:'🤘', url:'https://somafm.com/metal130.pls',                genre:'Metal'    },
  { id:'int_pop',        name:'Pop Internacional',       emoji:'🌟', url:'https://stream.zeno.fm/2e0hmqrmb5zuv',           genre:'Pop'      },
  { id:'int_edm',        name:'EDM / Dance',             emoji:'🎡', url:'https://somafm.com/defcon130.pls',               genre:'EDM'      },
  { id:'int_electronic', name:'Cliqhop Electronic',      emoji:'⚡', url:'https://somafm.com/cliqhop130.pls',              genre:'Eletrônico'},
  { id:'int_80s',        name:'Left Coast 70s/80s',      emoji:'📻', url:'https://somafm.com/seventies130.pls',            genre:'80s'      },
  { id:'int_90s',        name:'PopTron 90s/2000s',       emoji:'💿', url:'https://somafm.com/poptron130.pls',              genre:'90s'      },
  { id:'int_reggae',     name:'Reggae Vibes',            emoji:'🌴', url:'https://stream.zeno.fm/7f0hmqrmb5zuv',           genre:'Reggae'   },
  { id:'int_jazz',       name:'Jazz (SomaFM)',           emoji:'🎷', url:'https://somafm.com/somaside130.pls',             genre:'Jazz'     },
  { id:'int_classical',  name:'Clássico / Ambient',      emoji:'🎻', url:'https://somafm.com/dronezone130.pls',            genre:'Clássico' },
  { id:'int_ambient',    name:'Drone Zone (Ambient)',    emoji:'🌙', url:'https://somafm.com/dronezone256.mp3',            genre:'Ambient'  },
  { id:'soma_indie',     name:'Space Station (SomaFM)',  emoji:'🌈', url:'https://somafm.com/spacestation130.pls',         genre:'Space'    },
];
